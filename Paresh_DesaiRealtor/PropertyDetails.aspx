...
<div class="Detail_Left">
 <asp:Label ID="lblAddressBar1" Visible="false" runat="server" Text=""></asp:Label>
     ...
     <div id="popup_back_blur" class="email_bg">
        <div class="Detail_Email">
            <uc:PropertyDemo ID="PropertyDemo1" runat="server" />
        </div>
    </div>
            ...
            <div style="float: left; width: 100%; background: white; border-radius: 6px; padding:10px;">
                ...
                <div style="float: left; width: 100%; margin-bottom: 12px;">
                    ...
                    <div style="float: left; width: 33%; margin-top: 20px;">
                        <h2 style="margin-bottom: 5px; font-family:arial; font-size: 18px;">Yoginder Chahal</h2>
                        <p style="margin-bottom: 5px; font-family:arial;">Broker</p>
                        <p style="font-weight: bold; margin-bottom: 5px; font-family:arial;">E-Mail:<span style="font-weight: normal; margin: 0 0px 0 6px;">info@yogiproperties.com</span></p>
                        <p style="font-weight: bold; margin-bottom: 5px; font-family:arial;">Phone:<span style="font-weight: normal; margin: 0 0px 0 6px;">416-727-1962</span></p>
                    </div>
        ...
        <div class="modal-dialog">
            ...
            <div class="modal-content new_pop">
                ...
                <div class="modal-body modl_bg">
                    <div class="modl_sct">
                        <%--<label>Name</label>--%>
                        <input type="text" id="txtName" Placeholder="Name" pattern="[a-zA-Z\s]+" title="Enter your name" value="" runat="server" />

                    </div>
                    <div class="modl_sct">
                        <%--<label>Email</label>--%>
                        <input type="text" name="email" id="txtEmailID" Placeholder="E-Mail" pattern="[a-z0-9._%+-]+@[a-z0-9.-]+\.[a-z]{2,3}$" title="Enter your emailID" runat="server" value="" />

                    </div>
                    <div class="modl_sct">
                       <%-- <label>Phone</label>--%>
                        <input type="text" id="txtPhone" pattern="[0-9]{10}" title="Enter your mobile number" Placeholder="Phone number" value="" runat="server" />
                ...
                <div class="modal-footer mdl_fter">
