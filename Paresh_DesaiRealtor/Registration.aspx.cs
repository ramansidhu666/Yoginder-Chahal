        ...
        protected void btnSave_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                else
                {
                    ...
                    cmd1.Parameters.AddWithValue("@DateofBirth", txtDateofBirth.Text);
                    ...
                    string Url = Request.Url.AbsoluteUri.Replace("Login.aspx", "Verification.aspx?UserID=" + EncodeUserId);
