<%@ Page Language="C#" AutoEventWireup="true" MasterPageFile="~/landing_master.Master" CodeBehind="Seller.aspx.cs" Inherits="Property.Seller" %>
    ...
    <div id="main-wrap" class="clearfix">
        <div class="main-container bg clearfix ">
            <div style="padding-top: 76.2px;" class="addre-box-header">
                ...
                <h1 id="siteLiveHomePageMainTitle">Sellers</h1>
                <%--<h3>Get instant Free Online Home Evaluation</h3>--%>
                <h2><span class="line">&nbsp;</span><span id="siteLiveHomePageSmallerTitle1">We cover up to $1500 in closing costs*</span><span class="line">&nbsp;</span></h2>
