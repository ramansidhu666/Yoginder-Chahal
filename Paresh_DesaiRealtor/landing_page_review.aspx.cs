...
namespace Property
{
    public partial class landing_page_review : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            {
                lblHeading.InnerText = "Buyers";
                lblHeading1.InnerText = "We cover up to $1500 in closing costs";
            }
            else if(path.Contains("InboxInfo"))
            {
                lblHeading.InnerText = "Get listings in your inbox every morning";
            }
            else
            {
                lblHeading.InnerText = " Good News! We found multiple properties in your selected area.";
            }
        }
