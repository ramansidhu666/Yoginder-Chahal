...
namespace Property
{
    public partial class PreConstructionCondos : System.Web.UI.Page
    {
        ...
        protected void btnSend_Click(object sender, EventArgs e)
        {
            ...
            {
                cls_Property clsp = new cls_Property();
                clsp.Insert_PreConstructionCondos(txtName.Text, txtEmail.Text, txtPhoneno.Text, Convert.ToString(ddlPriceRange.SelectedValue), Convert.ToString(ddlCity.SelectedValue));
        ...
        public void SendMailToAdmin(string UserEmailId)
        {
            ...
            mail.Subject = "Yoginder Chahal Property";
            string body = "";
