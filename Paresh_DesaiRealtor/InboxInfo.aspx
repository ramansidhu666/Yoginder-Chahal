<%@ Page Language="C#" AutoEventWireup="true" MasterPageFile="~/landing_master.Master" CodeBehind="InboxInfo.aspx.cs" Inherits="Property.InboxInfo" %>
        ...
        <div id="main-wrap" class="clearfix">
            <div  class="main-container bg clearfix ">
                ...
                <div style="padding-top: 76.2px;" class="addre-box-header">
                    ...
                    <h1 id="siteLiveHomePageMainTitle">Get your Listing Every Morning</h1>
                    ...
                    <h2 id="siteLiveHomePageSmallerTitle">Get Listings in your Inbox Every Morning</h2>
                     <div class="">
