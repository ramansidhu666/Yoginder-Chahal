        ...
        <div class="module" id="newletter_div">
            ...
            <div class="module-body">
                ...
                <div class="form-horizontal row-fluid">
                        ...
                        <div style="float: left; width: 97%; background-color: #8a5201; padding: 12px;">
                            <div style="float: left; width: 97%; background-image: url(/PostCardImages/border.png); background-size: cover; background-color: #8a5201;">
                                ...
                                <div id="property_photo_div" data-id="openhouse" style="float: left; width: 100%; text-align: center; margin: 6px 0;">
                                    <img id="property_photo" src="../PostCardImages/open_house_img.jpg" alt="" title="" style="border-radius: 14px; border: 2px solid white; width: 78%; height:400px;" />
                                </div>
                            </div>
                        ...
                        <div style="float: left; width: 97%; background-color: #8a5201; padding: 12px;">
                            ...
                            <div style="float: left; width: 60%; text-align: center; margin: 8px 0;">
                                <div style="float: left; width: 100%; text-align: center;">
                                    ...
                                    <h2 style="float: left; margin: 6px 0; text-align: center; width: 100%; color: white; font-family: Arial, Helvetica, sans-serif; font-size: 20px; font-weight: bold;">Yoginder Chahal</h2>
                    <p style="float: left; text-align: center; margin: 2px 0; width: 100%; color: white; font-family: Arial, Helvetica, sans-serif; font-size: 16px;">P: 416-727-1962</p>
                    <p style="float: left; text-align: center; width: 100%; margin: 2px 0; color: white; font-family: Arial, Helvetica, sans-serif; font-size: 16px;">info@yogiproperties.com | www.yogiproperties.com/</p>
                    ...
                    <p style="float: left; text-align: center; width: 100%; color: white; margin: 2px 0; font-family: Arial, Helvetica, sans-serif; font-size: 16px;">470 Chrysler Dr # 20, Brampton, L6S0C1</p>
                                </div>
                            </div>
                            <div style="float: left; width: 100%; text-align: center;">
                                <img src="/PostCardImages/futer_border.png" alt="" title="" style="width: 100%;" />
                    ...
                    <div class="newsltr_bg">
                        <div id="feature_Front" style="float: left; width: 99%; background-color: #FFF; display: none; padding: 12px;">
                            ...
                            <div id="featured_first_imge" data-id="featured_first" style="float: left; width:100%; max-height:400px;">
                                <img id="featured_first_img" src="../PostCardImages/featurd_img1.png" alt="" title="" style=" width:100%; max-height:400px;/>
                            </div>
                            ...
                            <div style="float: left; width: 100%; margin: 8px 0; text-align: center; margin-top:35px;">
                                <img src="../PostCardImages/border_futer1.png" alt="" title="" style="margin: 8px 0; width: 55%;" />
                            </div>
                            <div style="float: left; width: 100%; margin: 8px 0;">
                                <div style="float: left; width: 35%;">
                                    <img src="../images/client_img.png" alt="" title="" style="width: 85%;" />
                                </div>
                                <div style="float: left; width: 65%;">
                                    <div style="float: left; background-color: #e8eaec; border-radius: 12px; padding: 12px;">
                                        <h2 style="float: left; width: 100%; color: #1c1c1c; font-size: 28px; font-weight: bold; font-family: 'Times New Roman', Times, serif; font-style: italic; margin: 6px 0;">Yoginder Chahal</h2>
                                        <p style="float: left; width: 100%; color: #222222; font-family: 'Times New Roman', Times, serif; font-style: italic; font-size: 18px; margin: 2px 0;">Call: 416-727-1962</p>
                                        <p style="float: left; width: 100%; color: #222222; font-family: 'Times New Roman', Times, serif; font-style: italic; font-size: 18px; margin: 2px 0;">Email: info@yogiproperties.com</p>
                                        <p style="float: left; width: 100%; color: #222222; font-family: 'Times New Roman', Times, serif; font-style: italic; font-size: 18px; margin: 2px 0;">Website: www.yogiproperties.com/</p>
                    ...
                    <div class="newsltr_bg" id="feature_Back" style="display: none">
                        <div style="float: left; width: 100%; background-color: #FFF; padding: 12px;">
                                ...
                                <div style="float: left; width: 100%; margin: 12px 0;">
                                    <div style="float: left; width: 100%; text-align: center;">
                                        <div id="featured_second_imge" data-id="featured_second" style="float: left; width: 48%; padding: 6px;">
                                            <img id="featured_second_img" src="../PostCardImages/featrd_img1.jpg" alt="" title="" style="width: 100%; height:250px; border: 2px solid white;" />
                                        </div>
                                        <div id="featured_thirld_imge" data-id="featured_thirld" style="float: left; width: 48%; padding: 6px;">
                                            <img id="featured_thirld_img" src="../PostCardImages/featrd_img2.jpg" alt="" title="" style="width: 100%;  height:250px; border: 2px solid white;" />
                                        </div>
                                    </div>
                                    <div style="float: left; width: 100%; text-align: center;">
                                        <div id="featured_fourth_imge" data-id="featured_fourth" style="float: left; width: 48%; padding: 6px;">
                                            <img id="featured_fourth_img" src="../PostCardImages/featrd_img1.jpg" alt="" title="" style="width: 100%;  height:250px; border: 2px solid white;" />
                                        </div>
                                        <div id="featured_fifth_imge" data-id="featured_fifth" style="float: left; width: 48%; padding: 6px;">
                                            <img id="featured_fifth_img" src="../PostCardImages/featrd_img2.jpg" alt="" title="" style="width: 100%;   height:250px; border: 2px solid white;" />
                                        </div>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div style="float: left; width: 100%; margin: 8px 0; text-align: center; background-color: #101010; padding: 12px 0;">
                                <h2 style="float: left; width: 100%; color: white; font-family: Arial, Helvetica, sans-serif; font-size: 18px; margin: 4px 0; font-weight: bold;">Yoginder Chahal (Sales Representative)</h2>
                        ...
                        <div style="float: left; width: 100%; background-color: #FFF; padding: 12px 0;">
                            ...
                            <div style="float: left; width: 97%; margin: 12px 0; background-color: #e3e3e3; padding: 6px; border-radius: 8px;">
                                <div style="float: left; width: 100%; margin: 12px 0; text-align: center;">
                                    ...
                                    <asp:TextBox ID="ftr_2nd_3rdcntnt" MaxLength='900' onkeyDown="checkTextAreaMaxLength(this,event,'900');" Style="float: left; white-space: normal; height: 165px; border: none; width: 100%; font-family: Arial, Helvetica, sans-serif; font-size: 15px; margin: 12px 0 0; color: #333333; line-height: 26px; text-align: justify;" runat="server" TextMode="MultiLine" PlaceHolder="" class="span8">
                    ...
                    <div class="newsltr_bg" id="2nd_featured_back" style="display: none">
                        <div style="float: left; width: 100%; background-color: #FFF; padding: 12px;">
                                ...
                                <div style="float: left; width: 100%; margin: 12px 0;">
                                    <div style="float: left; width: 100%; text-align: center;">
                                        <div style="float: left; width: 48%; padding: 6px;" id="2nd_ftr_2ndimg" data-id="2nd_ftr_2ndimg">
                                            <img id="ftr_2nd_2ndimge" src="../PostCardImages/featrd_img1.jpg" alt="" title="" style="width: 100%; height:250px; border: 2px solid white;" />
                                        </div>
                                        <div style="float: left; width: 48%; padding: 6px;" id="2nd_ftr_3rdimg" data-id="2nd_ftr_3rdimg">
                                            <img id="ftr_2nd_3rdimge" src="../PostCardImages/featrd_img1.jpg" alt="" title="" style="width: 100%; height:250px; border: 2px solid white;" />
                                        </div>
                                    </div>
                                    <div style="float: left; width: 100%; text-align: center;">
                                        <div style="float: left; width: 48%; padding: 6px;" id="2nd_ftr_4thimg" data-id="2nd_ftr_4thimg">
                                            <img id="ftr_2nd_4thimge" src="../PostCardImages/featrd_img1.jpg" alt="" title="" style="width: 100%; height:250px; border: 2px solid white;" />
                                        </div>
                                        <div style="float: left; width: 48%; padding: 6px;" id="2nd_ftr_5thimg" data-id="2nd_ftr_5thimg">
                                            <img id="ftr_2nd_5thimge" src="../PostCardImages/featrd_img1.jpg" alt="" title="" style="width: 100%;  height:250px; border: 2px solid white;" />
                                        </div>
                                    </div>
                                    <div style="float: left; width: 100%; text-align: center;">
                                        <div style="float: left; width: 48%; padding: 6px;" id="2nd_ftr_6thimg" data-id="2nd_ftr_6thimg">
                                            <img id="ftr_2nd_6thimge" src="../PostCardImages/featrd_img1.jpg" alt="" title="" style="width: 100%; height:250px; border: 2px solid white;" />
                                        </div>
                                        <div style="float: left; width: 48%; padding: 6px;" id="2nd_ftr_7thimg" data-id="2nd_ftr_7thimg">
                                            <img id="ftr_2nd_7thimge" src="../PostCardImages/featrd_img1.jpg" alt="" title="" style="width: 100%; height:250px; border: 2px solid white;" />
                                        </div>
                                    </div>
                                    <div style="float: left; width: 100%; margin: 8px 0; text-align: center;">
                                        <img src="../PostCardImages/featurd_border2.png" alt="" title="" style="margin: 8px 0; width: 55%;" />
                            ...
                            <div style="float: left; width: 100%; margin: 8px 0; text-align: center; background-color: #101010; padding: 12px 0;">
                                <h2 style="float: left; width: 100%; color: white; font-family: Arial, Helvetica, sans-serif; font-size: 18px; margin: 4px 0; font-weight: bold;">Yoginder Chahal</h2>
                                <p style="float: left; width: 100%; color: white; font-family: Arial, Helvetica, sans-serif; font-size: 18px; margin: 2px 0;">HomeLife/Miracle Realty Ltd., Brokerage</p>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="newsltr_bg" id="jst_sold_front" style="display: none">
                        <div style="float: left; width: 98%; background-color: #FFF; padding: 12px;">
                            <div style="float: left; width: 99%; background-color: #bc8b3d; text-align: center; padding: 6px 0px; margin-bottom: 6px;">
                                <img src="../PostCardImages/jst_sld_img1.png" alt="" title="" style="width: 42%;" />
                            </div>
                            <div style="float: left; width: 100%;">
                                <img id="jsthold_1stimge" data-id="jsthold_1stimge" src="../PostCardImages/featurd_img1.png" alt="" title="" style="width:99%; height:400px;/>
                            </div>
                            <div style="float: left; width: 100%;">
                            ...
                            <div style="float: left; width: 99%; margin: 12px 0; background-color: #e3e3e3; padding: 6px 0px;">
                                <div style="float: left; width: 100%;">
                                    <div style="float: left; width: 35%;">
                                        <img src="../images/client_img.png" alt="" title="" style="width: 80%;" />
                                    </div>
                                    <div style="float: left; width: 65%;">
                                        <div style="float: left; padding: 6px;">
                                            <h2 style="float: left; width: 100%; color: #b80a05; font-size: 28px; font-weight: bold; font-family: 'Times New Roman', Times, serif; font-style: italic; margin: 6px 0; border-bottom: 1px solid;">Yoginder Chahal</h2>
                                            <p style="float: left; width: 100%; color: #222222; font-family: 'Times New Roman', Times, serif; font-style: italic; font-size: 18px; margin: 2px 0;">Call: 416-727-1962</p>
                                            <p style="float: left; width: 100%; color: #222222; font-family: 'Times New Roman', Times, serif; font-style: italic; font-size: 18px; margin: 2px 0;">Email: info@yogiproperties.com</p>
                                            <p style="float: left; width: 100%; color: #222222; font-family: 'Times New Roman', Times, serif; font-style: italic; font-size: 18px; margin: 2px 0;">Website: www.yogiproperties.com/</p>
                                ...
                                <div style="float: left; width: 100%; margin: 4px 0;">
                                    <div style="float: left; width: 100%; padding: 8px;">
                                        <div style="float: left; width: 48%; padding: 6px; background-color: #bc8b3d;">
                                            ...
                                            <img id="jsthold_2ndimge" data-id="jsthold_2ndimge" src="../PostCardImages/featrd_img1.jpg" alt="" title="" style="width: 100%; height:200px; border: 2px solid white;" />
                                        ...
                                        <div style="float: left; width: 48%; padding: 6px; background-color: #bc8b3d;">
                                            ...
                                            <img id="jsthold_3rdimge" data-id="jsthold_3rdimge" src="../PostCardImages/featrd_img1.jpg" alt="" title="" style="width: 100%; height:200px; border: 2px solid white;" />
                                    ...
                                    <div style="float: left; width: 100%; padding: 8px;">
                                        <div style="float: left; width: 48%; padding: 6px; background-color: #bc8b3d;">
                                            ...
                                            <img id="jsthold_4thimge" data-id="jsthold_4thimge" src="../PostCardImages/featrd_img1.jpg" alt="" title="" style="width: 100%; height:200px; border: 2px solid white;" />
                                        ...
                                        <div style="float: left; width: 48%; padding: 6px; background-color: #bc8b3d;">
                                            ...
                                            <img id="jsthold_5thimge" data-id="jsthold_5thimge" src="../PostCardImages/featrd_img1.jpg" alt="" title="" style="width: 100%; height:200px; border: 2px solid white;" />
                                    ...
                                    <div style="float: left; width: 100%; padding: 8px;">
                                        <div style="float: left; width: 48%; padding: 6px; background-color: #bc8b3d;">
                                            ...
                                            <img id="jsthold_6thimge" data-id="jsthold_6thimge" src="../PostCardImages/featrd_img1.jpg" alt="" title="" style="width: 100%; height:200px; border: 2px solid white;" />
                                        ...
                                        <div style="float: left; width: 48%; padding: 6px; background-color: #bc8b3d;">
                                            ...
                                            <img id="jsthold_7thimge" data-id="jsthold_7thimge" src="../PostCardImages/featrd_img1.jpg" alt="" title="" style="width: 100%; height:200px; border: 2px solid white;" />
