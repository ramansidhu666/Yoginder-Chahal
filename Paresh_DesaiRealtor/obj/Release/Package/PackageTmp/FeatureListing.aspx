        ...
        <asp:DataList ID="dlFeatured" runat="server" RepeatColumns="3" RepeatLayout="Flow"
            ...
            <ItemTemplate>
                        <div class="search_boxx_list_5">
                            <div class="search_boxx_right_bg">
                                <a href='PropertyDetails.aspx?MLSID=<%# Eval("MLS")%>&PropertyType=<%#Eval("pType") %>'>
                                    <div class="search_boxx_left">
                                        <img src='<%# Eval("pImage")%>' alt="FeaturedProperty" title="Featured Property" /></div>
                                    ...
                                    <%# Eval("Address") %>,<%# Eval("PostalCode")%></a></span><div class="para">
                                        <p>
                                            <%# GetText(Eval("RemarksForClients").ToString())%></p>
                                    </div>
                            </div>
                            <div class="search_boxx_right_bg_2">
                                <span>$<%# Eval("ListPrice")%></span><br /><div class="detl">
                                    <ul>
                            ...
                            <div class="inform_list">
                                    <div class="infor_list">
                                       <%--    <asp:ImageButton ID="ImgAppointment" ImageUrl="~/images/date2.png" CommandName="Appointment"
                                            runat="server" ToolTip="Schedule Appointment"></asp:ImageButton>--%>
                                    ...
                                    <div class="infor_list_2">
                                     <p><a href="#"><i class="fa fa-star"></i></a></p>
                                        <%--  <asp:ImageButton ID="ImgFavourite" ImageUrl="~/images/favorite.png" CommandName="AddFavourite"
                                            CommandArgument='<%# Eval("MLS") %>' runat="server" ToolTip="Add to Favourite">
                                        </asp:ImageButton>--%>
                                        <span id="favouriteSpan" runat="server">Add to Favourite</span>
                                    </div>
                                    <div class="infor_list_3">
                                       <%--     <asp:ImageButton ID="btnEmail" ImageUrl="~/images/icons/incoming-email-icon copy.png"
                                            CommandName="Email" ToolTip="Click to Send Email" CommandArgument='<%# Eval("MLS") %>'
                                    ...
                                    <div class="infor_list_3">
                                           <%-- <asp:ImageButton ID="btnDetails" ImageUrl="~/images/icons/stock_view-details.png"
                                            CommandName="Details" ToolTip="Click For Details" CommandArgument='<%# Eval("MLS") %>'
                                            runat="server"></asp:ImageButton>--%>
                            ...
                            <%--  <span>Garage:
                    <%# Eval("GarageSpaces")%></span> <span>Beds:
                        <%# Eval("Bedrooms")%></span> <span>Baths:
                            <%# Eval("Washrooms")%></span>--%>
