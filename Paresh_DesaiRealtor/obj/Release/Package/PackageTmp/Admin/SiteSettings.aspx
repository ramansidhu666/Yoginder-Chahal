            ...
            <div class="module">
                ...
                <div class="module-body">
                    ...
                    <div class="form-horizontal row-fluid">
                        ...
                        <%-- <div class="control-group">
                            <label class="control-label" for="basicinput">Owner Two Phone Number</label>
                            <div class="controls">
                                <asp:TextBox ID="txtphone2" runat="server" PlaceHolder="Owner Phone Number..." class="span8"></asp:TextBox>
                            </div>
                        </div>--%>
                        <div class="control-group">
                        ...
                        <div class="control-group">
                            ...
                            <div class="controls">
                                ...
                                <%--<asp:Button Style="margin-bottom: 54px; margin-left: 166px;" ID="btnfavdelete" Text="Remove" runat="server" OnClick="btnfavdelete_Click" />--%>
                            </div>
                        </div>
                        <div class="control-group">
                            <label class="control-label" for="basicinput">Header Logo</label>
                            <div class="controls">
                                <asp:FileUpload ID="updbanner1" runat="server" />
                        ...
                        <div class="control-group">
                            ...
                            <div class="controls">
                                ...
                                <asp:Image ID="Imgbanner" alt="" Width="200px" runat="server" Visible="false" />
                                ...
                                <%--<asp:Button Style="margin-bottom: 54px;" ID="btnlogodelete" Text="Remove" runat="server" OnClick="btnlogodelete_Click" />--%>
                            </div>
                        </div>
                        <div class="control-group">
                            <label class="control-label" for="basicinput">Owner Brokerage</label>
                            <div class="controls">
