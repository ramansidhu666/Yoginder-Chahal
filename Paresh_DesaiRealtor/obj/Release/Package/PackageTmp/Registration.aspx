                       ...
                       ForeColor="Red" Display="Dynamic" ValidationExpression="^[a-zA-Z ]+$"  > </asp:RegularExpressionValidator> 
                            ...
                            <div>
                               <div class="login_input">
                                   ...
                                   <label style="color:red">*</label>
                                   <asp:TextBox ID="txtDateofBirth" runat="server" MaxLength="20" PlaceHolder="Date of Birth"></asp:TextBox>
                                  <ajaxtoolkit:CalendarExtender ID="txtDate_CalendarExtender" Format="MM/dd/yyyy" TargetControlID="txtDateofBirth" runat="server"></ajaxtoolkit:CalendarExtender>
                                   <asp:RequiredFieldValidator ID ="rfvDateofBirth" runat="server" ErrorMessage="Date of Birth is Required" 
                                       ControlToValidate="txtDateofBirth" ForeColor="Red" ValidationGroup="SaveRegInfo" Display="Dynamic"></asp:RequiredFieldValidator>
                       ...
                       ForeColor="Red" Display="Dynamic" ValidationExpression="^(0[1-9]|1[012])[- /.](0[1-9]|[12][0-9]|3[01])[- /.](19|20)\d\d+$"  > </asp:RegularExpressionValidator> 
                            ...
                            <div>
                                <div class="login_input">
                                    ...
                                    <label style="color: red">*</label>
                                    <asp:TextBox ID="txtPhoneNo" runat="server" MaxLength="10" PlaceHolder="Phone Number"></asp:TextBox>
                            ...
                            <div>
                                <div class="login_input">
                                    ...
                                    <asp:RequiredFieldValidator ID="rfvPassword" runat="server" ErrorMessage="Password is Required"
                                        ControlToValidate="txtPassword" Display="Dynamic" ForeColor="Red" ValidationGroup="SaveRegInfo"
                                        ></asp:RequiredFieldValidator>
                                     <asp:RegularExpressionValidator ID="RegularExpressionValidator4" runat="server" ValidationExpression="^[\s\S]{6,14}$"
