...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <div class="wrapper_new" >
        ...
        <h2>Useful Search Tools</h2></div>
        <ul>
        <li>
                <a target="_blank" href="http://www.canadapost.ca/cpotools/apps/fpc/personal/findAnAddress?execution=e3s1">
                    Postal Code to Address</a>
            </li>
         <li>
                <a target="_blank" href="http://www.canadapost.ca/cpotools/apps/fpc/personal/findByCity?execution=e1s1">
                    Find a Postal Code</a>
           </li>
           <li>
